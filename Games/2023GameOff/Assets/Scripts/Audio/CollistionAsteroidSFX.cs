...
public class CollistionAsteroidSFX : MonoBehaviour
{
    private FMOD.Studio.EventInstance collisionSound;
    private void OnCollisionEnter2D(Collision2D collision)
    {
        collisionSound = FMODUnity.RuntimeManager.CreateInstance("event:/SPACE/COLLISION/ASTEROID"); //create instance for sound
